        ...
        <div className={`mihistoria ${show ? 'fade-in' : ''}`}>
            <div className={`mihistoria-content ${show ? 'slide-in' : ''}`}>
                ...
                <p className="call-to-action">
                    Si te sientes identificado con lo que he contado y quieres cambiar tu situación,  <strong>puedes seguirme en mi canal gratuito de Telegram,</strong> donde subo varios pronósticos semanales, o <strong>contratar mis servicios</strong> para tener acceso a todos mis pronósticos. También puedes seguirme en Instagram y TikTok, donde doy consejos que te ayudarán a ser rentable en las apuestas deportivas.
                </p>
