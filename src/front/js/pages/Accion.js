            ...
            <div className="card-free">
                <div className="pricing-block-content">
                    ...
                    <div className="price-value" data-currency="$ USD" data-currency-simple="USD">
                        <p className="price-number">0<span className="price-integer">€</span></p>
                        <div id="priceDiscountCent">/mes</div>
                    </div>
                    <div className="pricing-note">Después 30,00€/mes</div>
